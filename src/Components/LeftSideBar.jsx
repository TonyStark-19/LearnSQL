...
const array2 = [
    ...
    { name: "SQL Commands", path: "/docs/commands" },
    { name: "Queries (Database)", path: "/docs/queries-DB" },
    { name: "Queries (Tables)", path: "/docs/queries-tables" },
    ...
    { name: "More Queries (Tables)", path: "/docs/More-queries" },
...
export default function Left({ menuOpen, setMenuOpen }) {
    ...
    return (
        ...
        max-lg:w-full max-lg:top-16 max-lg:z-50 max-lg:transition-transform max-lg:duration-300 ${menuOpen ? "max-lg:translate-x-0" : "max-lg:-translate-x-full"}`}>
            ...
            <div className="text-slate-500 pl-4 pt-4 font-semibold uppercase tracking-wider text-sm">Learn sql</div>
            ...
            <div className="text-slate-500 pl-4 pt-4 font-semibold uppercase tracking-wider text-sm">Resources</div>
